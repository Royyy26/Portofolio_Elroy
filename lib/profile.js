...
### 06 · Royale POS — Restaurant Point of Sale — React, Vite, Tailwind CSS, Recharts, Framer Motion
Sistem kasir untuk coffee shop & kitchen (Royale Coffee & Kitchen). Dibangun
sekitar tiga peran terpisah — kasir, gudang, dan owner — masing-masing hanya
melihat yang jadi tanggung jawabnya, dengan audit log. Fitur: checkout di bawah
30 detik dengan pintasan papan ketik dan kembalian otomatis; struk thermal 80mm
ber-QR verifikasi plus faktur A4; stok berkurang otomatis tiap penjualan dan
kembali saat void, lengkap dengan stok opname dan riwayat pergerakan; target
omzet bulanan dengan proyeksi akhir bulan; analitik owner berisi tren per jam
sampai per bulan, produk terlaris, komposisi pembayaran, dan estimasi margin.
Empat kanal pembayaran (tunai, QRIS, transfer, kartu) dan skema 16 tabel.
Demo live di royale-pos.vercel.app — akun demo terbuka untuk umum dan tertulis
di halaman depannya sendiri: owner / kasir / gudang, PIN 1234, sudah terisi 60
hari riwayat transaksi. Tidak ada repositori publik.

### 07 · OdeBistro — Java, NetBeans, MySQL
...
- AWS Academy Introduction to Cloud Semester 1 — Okt 2024
- AWS Academy Introduction to Cloud Semester 2 — Okt 2024
